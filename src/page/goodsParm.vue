  ...
  <section>
    <!--工具条-->
        ...
        <el-form-item class="fr">
					<el-button @click="handleAdd" type="primary">添加参数分类</el-button>
				</el-form-item>
			</el-form>
		</el-col>
    ...
    <el-dialog title="商品参数信息" :visible.sync="dialogFormVisible">
      <el-form :model="selectTable" >
        <el-form-item label="参数分类名称" :label-width="labelWidth">
